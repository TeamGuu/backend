...
public class SuccessMessage {
    ...
    public static final String SUCCESS_TO_GET_SIMPLE_TEAM_INFOS = "팀 목록을 가져오는데 성공했습니다.";
    ...
    public static final String SUCCESS_TO_GET_SIMPLE_MATCH_INFOS = "매칭 공고문 목록을 가져오는데 성공했습니다.";
    ...
    public static final String SUCCESS_TO_GET_CHAT_MEMBER_INFO = "채팅에 참여하는 회원 정보를 가져오는데 성공했습니다.";

    public static final String SUCCESS_TO_GET_SIMPLE_STADIUM_INFOS = "경기장 목록을 가져오는데 성공했습니다.";
